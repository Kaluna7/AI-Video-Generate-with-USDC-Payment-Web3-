      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            ...
            <br />
            <span className="text-white fade-in-up text-reveal inline-block" style={{ animationDelay: '0.2s' }}>
              Generation Platform
            </span>
          </h1>
          ...
          {/* Description */}
          <p 
            className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto fade-in-up text-reveal"
          ...
          >
            ...
            <button className="btn-3d w-full sm:w-auto px-8 py-4 glass-modern text-white rounded-xl font-semibold text-lg flex items-center justify-center gap-2 hover:bg-white/10 transition-all duration-300">
