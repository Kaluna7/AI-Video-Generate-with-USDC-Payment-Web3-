      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1">
            <h3 className="text-2xl font-bold gradient-text mb-4">V3 VideoGen AI</h3>
            <p className="text-gray-400 text-sm mb-6">
              Autonomous, onchain AI video generation platform. Generate stunning videos with Web3 payments.
            </p>
            <div className="flex space-x-4">
              {socialLinks.map((social, index) => (
                <a
                  key={index}
                  href="#"
                  className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-white/5 rounded-lg card-hover-3d"
        ...
        <div className="border-t border-gray-800/50 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © 2023 VideoGen AI. All rights reserved.
          </p>
