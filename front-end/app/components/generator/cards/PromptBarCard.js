...
export default function PromptBarCard({ item }) {
  return (
    <div className="w-full bg-gray-800/50 rounded-3xl border border-gray-700 overflow-hidden hover:border-purple-500/50 transition-all shadow-2xl">
        ...
        <div className="relative">
          <div className="aspect-video bg-gradient-to-br from-purple-500/20 via-blue-500/20 to-cyan-500/20 rounded-xl border border-gray-700 overflow-hidden group relative">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-black/60 backdrop-blur-sm px-4 py-3 flex items-center gap-3">
              ...
              <button className="w-8 h-8 bg-gray-700/80 rounded-full flex items-center justify-center hover:bg-gray-600 transition-colors shrink-0">
